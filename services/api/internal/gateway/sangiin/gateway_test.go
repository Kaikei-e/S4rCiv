...
// Markup copied from the live 参議院 vote-result page (221-0407-v001.htm, UTF-8):
// title → 議案件名, h2.kaiji_nichiji → 回次/日付, h3.tohyosousu → 票数, h4.party → 会派,
// li.giin → pros/cons/names spans.
...
<li class="giin"><span class="pros">賛成</span><span class="cons"></span><span class="names">青木　　一彦</span></li>
<li class="giin"><span class="pros">賛成</span><span class="cons"></span><span class="names">赤松　　　健</span></li>
</ul></dd></dl>
<h4 class="party">立憲民主・社民(38名)</h4>
<dl class="sanpilist"><dt class="party">賛成票 0　　　反対票 38</dt><dd><ul class="flex">
<li class="giin"><span class="pros"></span><span class="cons">反対</span><span class="names">青木　　　愛</span></li>
</ul></dd></dl>
</body></html>`
...
func TestParseVotePage(t *testing.T) {
	...
	if v := page.Votes[0]; v.Name != "青木 一彦" || v.Option != "yes" || v.Group != "自由民主党・無所属の会" {
		t.Errorf("vote[0] = %+v", v)
	}
	if v := page.Votes[2]; v.Name != "青木 愛" || v.Option != "no" || v.Group != "立憲民主・社民" {
		t.Errorf("vote[2] = %+v", v)
	}
}
